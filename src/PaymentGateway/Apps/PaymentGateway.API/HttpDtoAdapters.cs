...
namespace PaymentGateway.API
{
    public static class HttpDtoAdapters
    {
        ...
        {
            return new PaymentDetailsDto(paymentDetails.BankPaymentId, paymentDetails.CreditCardNumber, paymentDetails.CreditCardHolderName, paymentDetails.CreditCardExpiry, paymentDetails.CreditCardCvv, paymentDetails.Status);
        }
    }
}